...
Run.sh should handle these dependencies automatically (except the game files). Download the repository and execute it:
```
chmod +x run.sh
./run.sh
```
...
# About This Program
This program is a GNU/Linux fork of an NFS World backend (server emulator) originally written by Lawin0129 in Node.js which allows you to play the game locally.
